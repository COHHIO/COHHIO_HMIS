...
pe_score <- function(structure, value) {
  case_when(
    ...
    structure == "0_7_10_PSH" & between(value, 6, 7) ~ 10,
    structure == "0_7_10_PSH" & value == 5 ~ 9,
    structure == "0_7_10_PSH" & between(value, 3, 4) ~ 8,
    structure == "0_7_10_PSH" & value == 2 ~ 5,
    structure == "0_7_10_PSH" & value == 1 ~ 2,
    structure == "0_7_10_PSH" & value == 0 ~ 0,
    ...
    structure == "14_18_0" & value >=  .18 ~ 10,
    structure == "14_18_0" & value < .18 & value >= .16 ~ 7.5,
    structure == "14_18_0" & value < .16 & value >= .14 ~ 5,
    structure == "14_18_0" & value < .14 ~ 0,
