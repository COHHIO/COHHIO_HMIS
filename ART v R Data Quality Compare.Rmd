...
>The Disability subs Not Matching (138228) is because I'm not pulling in providers of type "Housing Only", and this EE is under Richland Place. Do we care about their Data Quality? Are they real? I have never included that project type in anything! (ART might be correct.)
...
>Missing HI at Entry (1753): This Entry Date is WELL before HI was being collected. The ART DQ report was ignoring it bc HUD said they didn't have to go back, but the APR doesn't heed that so we're thinking we should just let these come in as Errors. (Rm is correct.)
...
>Missing Income at Entry (and Exit) (1753): nothing from Richland Place is coming into Rm. (ART might be correct.)

>Missing NCBs at Entry (2407): nothing from Richland Place is coming into Rm. (ART might be correct.) (ART is correct.)
...
>Missing UDEs (13387): I don't know why this is pulling into the ART report. All seems fine when I look at the client record AND when I actually run the provider-level ART report. (!) (Rm is correct.)
