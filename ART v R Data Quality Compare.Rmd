...
>The Disability subs Not Matching (6011): The Yes subs have No's for "of long duration", but in R, the Developmental is getting an automatic "of long duration" because that's how it is in the FY2020 Data Standards. So that counts as a "Yes" for "of long duration" which means there is a sub to match the outside Yes. (Rm is correct.)
