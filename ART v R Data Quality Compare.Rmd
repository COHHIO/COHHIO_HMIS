...
>The Disability subs Not Matching is because I'm not pulling in providers of type "Housing Only", and this EE is under Richland Place. Do we care about their Data Quality? Are they real? I have never included that project type in anything! (ART might be correct.)

>Future Entry Exit (59947): For PSHs prior to 10/2016, Future Entry Exits were a common thing because the Entry Date was the Move In Date back then so users would often enter their clients into HMIS prior to the client moving in. (Rm is ok.)
...
>Missing Income at Entry (1753): should be conflicting income
