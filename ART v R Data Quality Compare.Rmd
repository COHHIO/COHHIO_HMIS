...
DataQualityHMIS <- as.data.frame(DataQualityHMIS) %>%
  filter(served_between(., "09012018", "09172019"))
...
Children Only Household (168314): The HoH was exited but the child was not. I don't know how ART is picking this up but it's cool as hell. Need to work this into Rme. (ART is correct)

The Disability subs Not Matching (149731): This Enrollment was entered after I created the exports so that's why it's not in R.
