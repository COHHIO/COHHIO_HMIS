...
The result here is Client 206291, who has an Exit Date of 1/1/2019. I thought it was an APR error but then I looked up the specs and it is not a vendor error but it nonetheless makes no sense. I put in an AAQ about the specs saying the Exit Date can = the Report Start Date.
...
The Client IDs shown here are 81061 and 177288. Both of these have Exit Dates of 1/1/2019 as well. 
...
Here it's returning two Client IDs that are different, but the vectors are only off by 1. Using the janitor package, I figured out there's a client with two EEs in this project during the reporting period. The Client ID is 197646 and they had a few months where they were not in the PSH, they were in a shelter, so everything is correct in HMIS, I just need to be sure this is being handled correctly in this reporting. Really both of these stays should not be counted here.

The other two clients exited on the Report Start Date. 
...
Client 125580 is duplicated in the R count. :(
