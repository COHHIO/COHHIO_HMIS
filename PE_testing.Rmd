...
The next one we'll cover is Butler - Butler County SPC for Homeless Individuals & Families - PSH.

R is showing they served 101 people, ART is saying there's only 49
...
The CoC APR has 101 clients served! Yikes, what is wrong with the ART report?
...
I do not know why Client 244 is not pulling into the ART report. It should be. Will need to look more closely at the ART logic at the office.
...
Client 180763 has two entries into the project, and both are showing in the ART report, whereas only one is showing in the R logic. Really ART seems right, as we want to capture every entry in these kinds of measures. Corrected logic in R.
