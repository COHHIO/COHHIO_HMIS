...
This map shows the total number of COVID Screening Tools reported in HMIS by county.
...
names(covid19_county_summary)[1] <- "NAME_2"
names(covid19_county_summary)[2] <- "Number of Screenings"
