...
covid19 <- read_csv(here(paste0(directory, "/covid19.csv")),
  ...
  mutate(
    ...
    DateDiagnosis = mdy(DateDiagnosis),
...
basic <- covid19 %>%
  ...
  mutate(
    ...
    DiagnosisPositive = case_when(
      is.na(DiagnosisPositive) |
        DiagnosisPositive == "No" ~ 0,
      DiagnosisPositive == "Yes" ~ 1),
    DiagnosisUnderInvestigation = case_when(
      is.na(DiagnosisUnderInvestigation) |
        DiagnosisUnderInvestigation == "No" ~ 0,
      DiagnosisUnderInvestigation == "Yes" ~ 1))
