...
### clients with 1 risk factor

```{r}

valueBox(number_of_risks$Clients[number_of_risks$NumberOfRisks == 1], 
         icon = "fa-trash",
         color = "primary")
```

### clients with 2 risk factors

```{r}
valueBox(number_of_risks$Clients[number_of_risks$NumberOfRisks == 2], 
         icon = "fa-trash",
         color = "warning")
```

### clients with 3 risk factors

```{r}
valueBox(number_of_risks$Clients[number_of_risks$NumberOfRisks == 3], 
         icon = "biohazard",
         color = "danger")
```
