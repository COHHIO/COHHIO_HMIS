...
priority <- covid19 %>%
  mutate(
    ...
    Priority = factor(Priority, levels = c("Isolation/Quarantine", 
                                           "High Risk", 
...
- The **Isolation/Quarantine** category indicates the household should be moved out of any congregate space immediately for quarantine due to a suspected or confirmed infection or likely exposure. Likely exposure could include having come into the system directly from prison or a nursing home.
- The **High Risk** category indicates the household needs non-congregate sheltering as the person is at high risk of poor outcomes if infected with COVID-19. 
